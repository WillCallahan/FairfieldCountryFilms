...
<header id="header">
    <div class="inner">
        ...
        <nav id="nav">
            <ul>
                <li id="home_tab"><a href="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/index.php">Home</a></li>
                <li id="about_tab">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/about/terms.php">Terms</a>
                            <ul>
                                ...
                                <li><a href="<?php echo "http://" . $_SERVER['SERVER_NAME']; ?>/contracts/wedding_contract.pdf">Wedding Contract</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
